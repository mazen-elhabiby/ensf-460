 ...
 * Group 20
 * Created on October 30, 2023, 2:52 PM
 */
...
// Configuration bits for the microcontroller - may need to be adjusted
///#pragma config FNOSC = FRC // Oscillator Selection (Internal Fast RC (FRC))
